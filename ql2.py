...
class QPlayer(Player):
    ...
    # states = 1+45*32*27*12
    # features = y[0,44]+1 x[0,31] p[0,26] t[0,11]
    def state(self, table):
        ...
        if dy <= 0:
            ...
            t = 2 + bisect(self.theta_dist, dx)

        assert 0 <= y < 45 and 0 <= x < 32 and 0 <= p < 27 and 0 <= t < 12, (y, x, p, t)

        return int(12*(27*(32*y + x) + p) + t)
